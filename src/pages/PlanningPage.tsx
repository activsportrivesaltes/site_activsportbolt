...
const locationStyles: Record<string, LocationStyle> = {
  'Ami-Club': {
    ...
    card: 'bg-brand-purple-100/60 ring-1 ring-brand-purple-200',
    dot: 'bg-brand-purple-800',
  },
  'Ancienne mairie': {
    badge: 'bg-brand-green-50 text-brand-green-700',
    card: 'bg-brand-green-100/60 ring-1 ring-brand-green-200',
    dot: 'bg-brand-green-500',
  },
  'Espace détente': {
    badge: 'bg-yellow-100 text-yellow-600',
    card: 'bg-yellow-100 ring-1 ring-yellow-200',
    dot: 'bg-yellow-500',
  },
  'Extérieur': {
    badge: 'bg-yellow-100 text-yellow-600',
